<?php
  $values = [
    ...
    'package_benefit_1' => 'Flat price',
    'package_benefit_2' => 'No FUP',
    'package_benefit_3' => 'Modem loaned',
    'package_benefit_4' => 'Support :device-count devices',
    'package_benefit_5' => 'Free maintenance fee',
    'package_benefit_6' => 'Free installation fee',
    'package_benefit_7' => 'Smart TV supported',
    ...
    'all' => 'All',
    'why_us' => 'Why Us?',
    'about_us_p2' => 'PT Azkyal Network Madina is the first and only local company engaged in the internet service provider sector in Mandailing Natal regency.',
    ...
    'vision' => 'Visions',
    'vision_1' => 'Providing internet solutions to remote villages in Mandailing Natal regency',
    'vision_2' => 'The realization of an internet network to support the development of digital technology in all corners of the villages of Mandailing Natal regency',
    'mission' => 'Missions',
    'mission_1' => 'Providing new standards of quality internet services',
    'mission_2' => 'Providing products that distribute the internet easily, thereby accelerating the distribution of the internet to all corners of the villages in Mandailing Natal regency.',
    'mission_3' => 'Providing access to digital technology information for the people of Mandailing Natal regency',
    'history' => 'History',
    'history_p' => 'This is the result of our achievements from year to year. Without giving up providing internet access solutions to remote villages in Mandailing Natal regency.',
    'history_2010_p' => 'We started our business from an internet cafe that was established in 2010 in Mandailing Natal regency. The internet cafe has been developed into 3 branches.',
    ...
    'history_2023_p' => 'Now, Azkyal is committed to internet marketing and sales to become the first local company in Mandailing Natal regency to provide a list of internet products from various internet service providers.',
